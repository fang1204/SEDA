    ...
    def eval(self, epoch, data_loader, is_test=False):
        ...
        with torch.no_grad():
            for i, data_batch in tqdm(enumerate(data_loader)):
                ...
                output_mask = torch.greater(outputs,0.75)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/share14_fix_length.json')
    parser.add_argument('--save_path', type=str, default='./model_share14_ori.pt')
